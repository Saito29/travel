                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <a href="<?php echo BASE_EDITOR.'/category/manage-subcategories.php?SNID='?><?php echo $_SESSION['id']?>">
                            ...
                            <div class="col-12 col-md-4">
                                <a href="<?php echo BASE_EDITOR.'/post/manage-post.php?SNID='?><?php echo $_SESSION['id']?>">
                                <div class="card cardh border-0">
                                    <div class="card-body py-4">                                    
                            ...
                            <div class="col-12 col-md-4">
                                <a href="<?php echo BASE_EDITOR.'/post/trash-post.php?SNID='?><?php echo $_SESSION['id']?>">
                                <div class="card cardh border-0">
                                    <div class="card-body py-4">                                    
