                                            ...
                                            <table class="table m-0 table-responsive-md table-bordered" style="width: 100%;" id="myTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit-subcategories.php?id=<?php echo htmlspecialchars( $subcategories['id']);?>" class="btn btn-outline-primary m-1"><i class='bx bx-edit'></i></a>
                                                            &nbsp;
                                                            <a href="manage-subcategories.php?del_id=<?php echo htmlspecialchars($subcategories['id']);?>" class="btn btn-outline-danger m-1"><i class='bx bx-trash-alt' ></i></a>
                                                        </td>
                                                    </tr>
                                                        <?php endforeach;?>
                                                    <?php endif;?>
                                            ...
                                            <table class="table m-0 table-responsive-md table-bordered" style="width: 100%;" id="DeletedmyTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlspecialchars($subcategories['updated_at']);?></td>
                                                        <td>
                                                            <a href="<?php echo BASE_ADMIN.'/category/manage-subcategories.php?id_rec='?><?php echo htmlspecialchars($subcategories['id']);?>" class="btn btn-outline-success m-1"><i class='bx bx-redo'></i></a>
                                                            &nbsp;
                                                            <a href="<?php echo BASE_ADMIN.'/category/manage-subcategories.php?id_del='?><?php echo htmlspecialchars($subcategories['id']);?>" class="btn btn-outline-danger m-1"><i class='bx bx-trash-alt' ></i></a>
                                                        </td>
                                                    </tr>
                                                        <?php endforeach;?>
                                                    <?php endif;?>
