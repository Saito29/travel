                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="#" class="row gx-2 gy-3" name="addUser" method="post">
                                            <div class="mb-1 col-md-6 form-group">
                                                <label for="addCateg" class="form-label">Category:</label>
                                                <input type="text" class="form-control p-2" name="addCateg" placeholder="Category Name" required>
                                            </div>
                                            <div class="mb-1 col-md-6 form-group">
                                                <label for="categDesc" class="form-label">Category Description:</label>
                                                <textarea name="categDesc" class="form-control" rows="4" placeholder="Category Description" required></textarea>
                                            </div>
