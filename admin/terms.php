...
<head>
    ...
    <meta name="description" content="Cube.io Terms & Conditions">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Cube.io | Terms & Conditions</title>
            ...
            <main class="content px-3 py-4">
                <div class="container-fluid mb-2">
                    <div class="d-flex justify-content-between  px-2 py-2" aria-label="breadcrumb">
                        <h3 class="fw-bold fs-4 mb-3">Terms & Conditions Page</h3>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 ">
                                               ...
                                               <div class="alert alert-success" role="alert">
                                                  <strong>Well done Terms page Successfully! updated</strong>
                                               </div>
                                               <!---Error Message--->
                                               <div class="alert alert-danger" role="alert">
                                                  <strong>Failed to update Terms page! Please try again later.</strong>
                                               </div>
                                            </div>
                                         </div>
