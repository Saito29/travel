...
<!--Pannellum scripts-->
<script src="<?php echo BASE_URL.'/vendor/pannellum-2.5.6/src/standalone/standalone.js'?>"></script>
<script src="<?php echo BASE_URL.'/vendor/pannellum-2.5.6/src/js/libpannellum.js'?>"></script>
<script>
