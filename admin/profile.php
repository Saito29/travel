                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="profile.php" class="row gx-2 gy-3" name="editUser" id="profile" method="post" autocomplete="on" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-1 col-sm-6">
                                                ...
                                                <input type="text" class="form-control" name="firstName" value="<?php echo htmlspecialchars($_SESSION['firstName'])?>" placeholder="First Name">
                                            </div>
                                            <div class="mb-1 col-sm-6">
                                                <label for="lastName" class="form-label">Last Name:</label>
                                                <input type="text" class="form-control" name="lastName" value="<?php echo htmlspecialchars($_SESSION['lastName'])?>" placeholder="Last Name">
                                            </div>
                                            <div class="mb-1 col-sm-6">
                                                <label for="username" class="form-label">Username:</label>
                                                <input type="text" class="form-control" name="username" value="<?php echo htmlspecialchars($_SESSION['username'])?>" placeholder="Username">
                                            </div>
                                            <div class="mb-1 col-sm-6">
                                                <label for="email" class="form-label">Email:</label>
                                                <input type="email" class="form-control" name="email" value="<?php echo htmlspecialchars($_SESSION['email'])?>" placeholder="Email Address">
                                            </div>
                                            <div class="mb-1 col-sm-6">
                                                <label for="profileImage" class="form-label">Profile Image:</label>
                                                <img src="<?php echo BASE_URL.'/app/upload/uploadProfile/'?><?php echo htmlspecialchars($_SESSION['profileImage'])?>" onclick="triggerProfileClick()" id="profileDisplay" class="rounded-circle d-block border" alt="profile-user" style="cursor:pointer" height="75" width="75">
                                            ...
                                            <div class="mb-1 col-sm-4">
                                                ...
                                                <input type="datetime-local" class="form-control" name="updated_at" value="<?php echo htmlspecialchars($_SESSION['updated_at'])?>">
                                            </div>
                                            <div class="mb-1 col-sm-6">
