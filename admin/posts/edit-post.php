                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title"><i class='bx bxs-edit-alt' style='color:#e915ef'></i>Edit Post Information</h4>
                                        <hr />
                                        <div class="row">
                                            <div class="col-sm-12">
                                               <!--Alert start-->
                                        ...
                                        <form action="edit-post.php" class="row gx-2 gy-3" autocomplete="on" name="editPost" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-1 col-sm-6">
                                                ...
                                                <p class="text-danger fs-6 px-2">required</p>
                                                <img src="<?php echo BASE_URL.'/app/upload/uploadThumbnail/'.htmlspecialchars($postImage)?>" alt="Thumbnail_Post" width="220" height="160">
                                            </div>
