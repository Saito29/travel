                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="add-post.php" class="row gx-2 gy-3" autocomplete="on" name="addPost" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-1 col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="title" placeholder="Enter Title" id="title" value="<?php echo htmlspecialchars($title)?>" required>
                                            ...
                                            <div class="mb-1 col-sm-12">
                                                ...
                                                <textarea name="description" id="description" class="form-control mytextarea" ><?php echo htmlspecialchars($description);?></textarea>
                                                <p class="text-danger fs-6 px-2">required</p>
                                            </div>
                                            <div class="mb-1 col-md-12 form-group">
                                                <label for="googleWidget" class="form-label">Embeded Google Widgets:</label>
                                                <textarea name="googleWidget" id="googleWidget" class="form-control mytextarea" ><?php echo htmlspecialchars($googleWidget);?></textarea>
                                                <p class="text-danger fs-6 px-2">required</p>
                                            </div>
                                            <div class="mb-1 col-sm-6">
                                                <label for="image" class="form-label">Feature Image:</label>
                                                <input type="file" class="form-control" name="image" id="image" accept="image/*" value="<?php echo htmlspecialchars($postImage);?>" required>
                                                <p class="text-danger fs-6 px-2">required</p>
                                            </div>
                                            <div class="mb-1 col-md-4 form-group">
                                                <label for="created_at" class="form-label">Post Created:</label>
                                                <input type="date" class="form-control" id="created_at" name="created_at" value="<?php echo htmlspecialchars($created_at);?>" required>
                                                <p class="text-danger fs-6 px-2">required</p>
                                            </div>
                                            <div class="mb-1 col-md-6 form-group">
